import 'dart:async';
import 'dart:convert';
import 'package:wallpaperdownloader/common/local/LocalStorage.dart';
...
class MySelfInfo {
  /*static removeSetting() async {
    ...
    await LocalStorage.remove(Config.portKey);
  ...
  static Future<String> getPost() async {
    return await LocalStorage.get(Config.portKey);
  }

  static setPost(String post) async {
    await LocalStorage.saveString(Config.portKey, post);
  }
